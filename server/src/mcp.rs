...
pub(crate) async fn list_handler(
    ...
    let raw = state.vm_config_ops.get_claude_json_raw(user_vm.guest_ip).await?;
...
mod tests {
    ...
    async fn list_handler_returns_servers() {
        let json = r#"{"mcpServers":{"my-server":{"type":"http","url":"https://example.com/mcp"}}}"#;
    ...
    async fn add_handler_creates_server() {
        ...
        assert_eq!(parsed["mcpServers"]["new-server"]["url"], "https://example.com/mcp");
    }
